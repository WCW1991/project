...
#define OS_EVENT_NAME_SIZE       30    /* Determine the size of the name of a Sem, Mutex, Mbox or Q    */
...
#define OS_TICKS_PER_SEC       1000    /* Set the number of ticks in one second                        */
                                       ...
                                       /* --------------------- TASK STACK SIZE ---------------------- */
#define OS_TASK_TMR_STK_SIZE    256    /* Timer      task stack size (# of OS_STK wide entries)        */
...
#define OS_TASK_NAME_SIZE        30    /*     Determine the size of a task name                        */
...
#define OS_TMR_CFG_MAX            6    /*     Maximum number of timers                                 */
#define OS_TMR_CFG_NAME_SIZE     30    /*     Determine the size of a timer name                       */
...
#define  OS_TASK_TMR_PRIO         1//(OS_LOWEST_PRIO - 2)
